...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-[#0a0f2c] to-[#080b1e] text-gray-300 pt-16 pb-8 px-6 md:px-12 lg:px-16 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          <Link to="/" className="inline-flex items-center space-x-3">
            <img src={logo} alt="Axenora Logo" className="h-12 w-12 md:h-14 md:w-14" />
          ...
          <ul className="space-y-3 text-sm md:text-base">
            <li className="flex items-start">
              ...
              <span className="text-gray-400">
                Axenora Technology (Pvt) Ltd., Galewela, Sri Lanka
              </span>
            </li>
            <li className="flex items-start">
              <FaEnvelope className="text-blue-400 mt-1 mr-3 flex-shrink-0" />
              <a
                href="mailto:info@axenora.com"
      ...
      <div className="border-t border-white/5 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-xs md:text-sm text-gray-500">
